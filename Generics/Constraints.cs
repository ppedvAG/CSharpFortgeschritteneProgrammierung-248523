...
public class Constraints
{
	...
	static void Test<T>() where T : Person, new()
	{
		...
		//Keywords
		Console.WriteLine(nameof(T)); //Name des Generics als String ("Int32", "String", "Boolean", ...)
		Console.WriteLine(typeof(T)); //Type Objekt des Generics
...
public class DataStore5<T> where T : new(); //Der Typ muss einen Standardkonstruktor
